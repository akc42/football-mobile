...
RUN IT to get the filter you have to use to replicate a color fill on svg images

node calcfilter.js <hex-color>
...
if (rgb.length !== 3) {
  console.log('Invalid format! for <hex color>');
  process.exit(1);
}
...
console.log('The filter to use to try and replicate the color ', input, ' is ...');
