    ...
    return html`
      <style>
        ...
        <div class="team aid">
          ...
          <material-icon @click=${this._deselectAid}>close</material-icon>
        </div>
        <div class="score ascore" @click=${this._setAscore}>
          <div class="title">Score</div>
          <div class="num">${this.match.ascore}</div>
        </div>
        <div class="under aunder"  @click=${this._makeUnderAid}>
        ...
        <div class="under hunder"  @click=${this._makeUnderHid}>
          <div class="dog">Underdog</div>
        ...
        <div class="team hid">
          ${cache(this.match.hid !==null && this.match.hid.length > 0 ? html`
            ...
            <material-icon @click=${this._deselectHid}>close</material-icon>    
          `:'')}
        </div>
        <div class="mt">
